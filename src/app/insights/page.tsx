...
export const metadata: Metadata = {
  title: 'Insights',
  description:
    'Field notes on AI and philanthropy by Dale Nirvani Pfeifer. Short essays on the practice of fundraising as automation scales.',
};
...
export default function InsightsPage() {
  ...
  return (
    <section className="container-prose pb-24 pt-16 md:pb-32 md:pt-24">
      <header className="max-w-3xl">
        ...
        <p className="mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-ink/75">
          Short essays on the practice of fundraising as automation scales. Subscribers receive
          new posts in their inbox the morning they go up.
        </p>
      </header>
            ...
            {posts.map((post) => (
              <li key={post.slug} className="bg-cream">
                ...
                >
                  ...
                  <div>
                    <h2 className="text-2xl font-extrabold leading-tight tracking-tight text-ink md:text-[1.65rem]">
                      {post.title}
                    </h2>
                    {post.excerpt && (
