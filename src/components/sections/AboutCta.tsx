    ...
    <section aria-labelledby="about-cta" className="container-prose py-20 md:py-28">
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 rounded-full px-3 py-3 text-sm font-semibold text-ink/70 underline decoration-ink/20 decoration-1 underline-offset-4 transition hover:text-ink hover:decoration-ink/60"
          >
            Get in touch
          </Link>
        </div>
